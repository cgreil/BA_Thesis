...
class H(AbstractMolecule):
    ...
    def get_integral_matrices(self) -> Tuple[NDArray, NDArray]:
        ...
        molecule = H._pyscf_create_h2()
        integral_tuple = (H._pyscf_1e_integrals(molecule), H._pyscf_2e_integrals(molecule))
    ...
    def _pyscf_create_h2():
        ...
        molecule.basis = {
            ...
            'H': parse_gaussian.load(
                '/home/christoph/PycharmProjects/Ba_Thesis_Documents/src/resources/H.gbs', 'H')
        }
